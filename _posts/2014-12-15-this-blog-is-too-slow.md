...
[latest post](http://www.nerdster.org/Helsinki/) took a painful 18 seconds:
...
The disk usage utility revealed that we have a grand total of 104 MB of images
on the site:
...
browse of the directory showed that hers account for the majority.
...
After pushing those changes, fetching the entire page took ~4.5 seconds; about a
75% speedup. A 4 second page load might not win any awards, but it's an enormous
improvement and certainly more reasonable.
